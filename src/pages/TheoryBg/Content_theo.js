...
const renderEquation = (symbol, description) => {
  return (<div><Equation value={symbol}/> = {description}</div>)
}



const Content_theo = ({title, subtitle,body, equation, equationFinal, variableList, body1, equationSub1,equationSub2}) => {
